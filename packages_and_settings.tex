...
\captionsetup[table][bi-second]{name=Table} %设置表的英文编号前缀W

\usepackage{ulem} %更好的下划线

\renewcommand{\cftsecfont}{\bfseries\songti}
% \usepackage{titlesec}
% \usepackage{titletoc}
...
\ctexset { section = { name={,、},format={ \heiti \zihao {-4}} } }         %
